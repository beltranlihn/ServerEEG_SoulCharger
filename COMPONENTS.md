...
| Monitor OSC en vivo | Tres osciloscopias por panel (calma, pulso, quietud) + cadencia real en Hz. Canvas plano, **no Chart.js** | `soul-charger-admin.html` (`SignalScope`, `drawScopes`, `updateReadouts`) | ✅ cifras verificadas; dibujo sin ver | R17 |
